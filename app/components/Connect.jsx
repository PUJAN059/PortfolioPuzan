  ...
  return (
    <section id="connect" className="py-16 sm:py-20 px-4 sm:px-6" ref={sectionRef}>
      <div className="max-w-4xl mx-auto text-center">
          ...
          {socials.map((social, i) => (
            ...
            >
              <a
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-2xl bg-[#393E46]/30 border border-[#EEEEEE]/5 hover:border-[#00ADB5]/50 hover:bg-[#00ADB5]/10 hover:shadow-[0_0_30px_rgba(0,173,181,0.15)] transition-all duration-500 hover:-translate-y-2"
              >
                <div className="text-[#EEEEEE]/60 group-hover:text-[#00ADB5] group-hover:scale-110 transition-all duration-300">
                  {social.icon}
                </div>
                <span className="text-sm font-medium text-[#EEEEEE]/70 group-hover:text-[#EEEEEE] transition-colors duration-300">
                  {social.name}
                </span>
              </a>
            </div>
        ...
        <div className="mt-16 animate-on-scroll delay-7">
          <p className="text-[#EEEEEE]/50 text-sm">
            &copy; {new Date().getFullYear()} Pujan Subedi. All rights reserved.
          </p>
        </div>
      </div>
    </section>
